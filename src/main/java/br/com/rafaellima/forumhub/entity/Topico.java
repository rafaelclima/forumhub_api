...
public class Topico {
	...
	public void updateTopico(UpdateTopicoDTO topicoRequest) {
		this.titulo = topicoRequest.titulo() != null ? topicoRequest.titulo()
				: this.titulo;
		this.mensagem = topicoRequest.mensagem() != null ? topicoRequest.mensagem()
				: this.mensagem;
	}
